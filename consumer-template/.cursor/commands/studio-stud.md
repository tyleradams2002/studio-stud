...
.\studio-stud query 139581542512435 --path Workspace/BoatSpawnPoints --limit 10
.\studio-stud query 139581542512435 --detail Workspace/Dock --props Position,Size
```

Places: MikesResort=`139581542512435`, KelleysIsland=`87774153727073`. Replace PlaceId from `status` or `analyze`.
