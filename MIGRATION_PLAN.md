...
- [ ] **Step 5 — Strip ExampleProject** per section 7 (delete Group A, neutralize Group B).
      (Requires Tyler's go-ahead: deletes files from ExampleProject; git-reversible.)
- [ ] **Step 6 — Reinstall into ExampleProject** via the one-liner (`--with-cursor-rule`) and smoke-test
