...
- Repo-wide grep for `31912`, `boat_plugin_connector`, `BoatConfigurator`, `ExampleProjectBoatConnector`
...
- Add `tools/studio_stud/tests/fixtures/baseline_capture.json` (or `.json.gz`, matching what
  ...
  place key, and timestamps so goldens and bench are reproducible. Prefer a real Example Project capture
