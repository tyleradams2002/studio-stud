...
- [ ] **Step 1: Write a failing test** — `tests/policy_place_ids.rs` deserializes a policy JSON with `"allowedPlaceIds": ["100000000000002"]` and asserts it parses and contains `100000000000002i64`:
